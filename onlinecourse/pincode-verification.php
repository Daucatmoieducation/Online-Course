...
echo '<script>alert("Error: Sai Pincode. Vui lòng nhập lại!!")</script>';
...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">XÁC MINH MÃ SINH VIÊN</h1>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="panel-body">
                        <form name="pincodeverify" method="post">
                            <div class="form-group">
                                <label for="pincode">Nhập Pincode</label>
